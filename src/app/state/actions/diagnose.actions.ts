...
export const GET_BY_DIAGNOSE_ID = '[Diagnose] Get by Id';
export const GET_BY_DIAGNOSE_ID_SUCCESS = '[Diagnose] Get by Id Success';
...
export class GetByCountryIdAction implements Action {
  readonly type = GET_BY_DIAGNOSE_ID;
  constructor(public payload: string) {}
}
export class GetByCountryIdSuccessAction implements Action {
  readonly type = GET_BY_DIAGNOSE_ID_SUCCESS;
